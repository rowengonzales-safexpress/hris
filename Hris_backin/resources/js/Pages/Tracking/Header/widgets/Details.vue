          ...
          <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
              <tr>
                ...
                <th class="px-4 py-2">Consignee/Store</th>
                <th class="px-4 py-2">Address</th>
                <th class="px-4 py-2">Drops</th>
              </tr>
            </thead>
            <tbody>
              <tr v-for="(rowData, index) in groupedStoresByCity" :key="index" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                <td class="px-4 py-2">
                  <div v-if="rowData.isFirstInCity" class="flex flex-col items-center bg-green-200 px-2 py-2 rounded">
                ...
                <td class="px-4 py-2">
                  <div v-if="rowData.isFirstInCity" class="flex flex-col items-center bg-green-50 px-2 py-2 rounded">
                    <span class="font-semibold text-lg text-green-700">{{ rowData.cityCount }}</span>
                    <span class="text-xs text-gray-600">{{ rowData.cityCount === 1 ? 'drop' : 'drops' }}</span>
                  </div>
                </td>
              </tr>
            </tbody>
