    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden">
        ...
        <div v-else-if="notifications.data.length === 0" class="p-8 text-center">
          ...
          <p class="text-gray-500 dark:text-gray-400">Admin notifications will appear here when they arrive</p>
        </div>
...
const markAsRead = async (notification: Notification) => {
  ...
  try {
    await axios.patch(`/admin/notifications/${notification.id}/mark-as-read`);
...
const applyFilter = () => {
  ...
  params.append('app_id', '1'); // Admin app_id
  ...
  const url = `/admin/notifications?${params.toString()}`;
  router.visit(url);
};
