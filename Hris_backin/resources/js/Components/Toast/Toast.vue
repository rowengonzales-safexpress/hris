...
export default {
  ...
  computed: {
    ...
    style() {
      return "flex self-center overflow-hidden rounded-xl cursor-pointer shadow-xl mb-5 pointer-events-auto";
    },
    shade() {
      switch (this.type) {
        case "info":
    ...
    createParent() {
      ...
      if (!this.parent) {
        ...
        this.parent.className =
          "fixed flex flex-col w-full h-full inset-0 p-10 z-50 pointer-events-none overflow-hidden";
      }
    },
    setupContainer() {
